...
def circle(radius_um, physical_length_um, Number_of_Samples):
    # Crea coordenadas físicas centradas en 0 (en micras)
    x = np.linspace(-physical_length_um/2, physical_length_um/2, Number_of_Samples)
    y = np.linspace(-physical_length_um/2, physical_length_um/2, Number_of_Samples)
    X, Y = np.meshgrid(x, y)
...
def rectangle(width_um, height_um, physical_length_um, Number_of_Samples):
    # Crea coordenadas físicas centradas en 0 (en micras)
    x = np.linspace(-physical_length_um/2, physical_length_um/2, Number_of_Samples)
    y = np.linspace(-physical_length_um/2, physical_length_um/2, Number_of_Samples)
    X, Y = np.meshgrid(x, y)
...
def vertical_slit(width_um, physical_length_um, Number_of_Samples):
    # Crea coordenadas físicas centradas en 0 (en micras)
    x = np.linspace(-physical_length_um/2, physical_length_um/2, Number_of_Samples)
    y = np.linspace(-physical_length_um/2, physical_length_um/2, Number_of_Samples)
    X, Y = np.meshgrid(x, y)
...
def horizontal_slit(width_um, physical_length_um, Number_of_Samples):
    # Crea coordenadas físicas centradas en 0 (en micras)
    x = np.linspace(-physical_length_um/2, physical_length_um/2, Number_of_Samples)
    y = np.linspace(-physical_length_um/2, physical_length_um/2, Number_of_Samples)
    X, Y = np.meshgrid(x, y)
...
"""
def cross_mask(L1_um, L2_um, h1_um, h2_um, t_um, e_um, physical_length_um, Number_of_Samples):
    # Crea coordenadas físicas centradas en 0 (en micras)
    x = np.linspace(-physical_length_um/2, physical_length_um/2, Number_of_Samples)
    y = np.linspace(-physical_length_um/2, physical_length_um/2, Number_of_Samples)
    X, Y = np.meshgrid(x, y)
...
def load_image(image_path, Number_of_Samples):
    ...
    img = img.resize((Number_of_Samples, Number_of_Samples))                 # Redimensionar a la matriz de simulación
