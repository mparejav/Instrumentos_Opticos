...
Δ_fx = 1 / (M_x_CAM2 * λ) #um^-1. sampling interval in the frequences domain in axis fx
Δ_fy = 1 / (M_y_CAM2 * λ) #um^-1. sampling interval in the frequences domain in axis fy
...
Δ_0 = (λ*f)/(Δ_1_CAM2*N)  # um. Sampling interval in the spatial domain.
...
U_B, x_1, y_1 = difractive_formulation (U_0,A,B,D,λ,Δ_0,Δ_1_CAM2,X_0,Y_0,M_x_CAM2,M_y_CAM2)

"""
5. Calculate I[n,m,z] - the intensity at distance z
""" 
I_CAM2 = np.abs(U_B)**2  # Intensity is the magnitude squared of the field
I_CAM2 = I_CAM2 / I_CAM2.max()  # Normalizing to its max value
...
plot_fields(I_0, I_CAM2, x_0, y_0, x_1, y_1, Cut_Factor=40, title0 = "Objeto", titlez = "Intensidad del Campo propagado:\n formulación difractiva")
